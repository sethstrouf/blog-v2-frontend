...
<footer class="bg-white">
  <div class="mx-auto max-w-7xl overflow-hidden px-6 py-4 sm:py-8 lg:px-8">
    <div class="flex justify-center space-x-10 sm:space-x-10">
      ...
      <a href="https://www.instagram.com/hannahraebauer/?hl=en" class="text-gray-400 hover:text-gray-500">
      ...
      <a href="https://twitter.com/hannahrbauer" class="text-gray-400 hover:text-gray-500">
